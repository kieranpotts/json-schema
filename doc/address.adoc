...
Address formats https://w3c.github.io/i18n-drafts/questions/qa-address-formats.en.html[vary widely around the world], and there is no single address format that works for all countries. This makes it difficult to define a standard address entity for global applications.
